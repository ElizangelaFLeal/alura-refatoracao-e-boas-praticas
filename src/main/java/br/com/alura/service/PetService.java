...
public class PetService {
    ...
    public PetService(HttpClientConfiguration client) {
        this.client = client;
    }
    public void listarPetsDoAbrigo() throws IOException, InterruptedException {
        ...
        PetDomain[] pets = new ObjectMapper().readValue(responseBody, PetDomain[].class);
        List<PetDomain> petList = Arrays.stream(pets).toList();
        System.out.println("Pets cadastrados:");
        for (PetDomain pet : petList) {
            long id = pet.getId();
